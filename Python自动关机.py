...
menu.current(1)      # 设置默认值，即默认下拉框中的内容
...
#常用的时间按钮
for i in range(2, 7):
    button = tkinter.Button(win, text=str(i * 15) + "min", command=lambda x=i: change_edit(str(x * 15)))
...
#取消按钮
cancel_button = tkinter.Button(win, text='取消', width=6, height=1, command=cancel)
cancel_button.place(x=250, y=85)


# author
author = tkinter.Label(win, text='请我喝杯咖啡吗？', font=(10))
